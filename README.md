...
```bash
git clone https://github.com/actionanand/ngrx-standalone.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/ngrx-standalone#1-skeleton angular-proj-name
```
